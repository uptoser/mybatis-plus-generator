...
public class CodeGenerator {
    private static String PROJECT_NAME = "";// 生成的代码放到哪个工程中
    private static String DATABASE_NAME = "mybatis-test";// 数据库名称
    private static String MODULE_NAME = "mybatis";// 子包名
    private static String PREFIX = "t_"; // 前缀名
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://192.168.3.200:3306/"+ DATABASE_NAME +"?useUnicode=true&characterEncoding=utf8&useSSL=false&serverTimezone=GMT%2B8");
        ...
        pc.setParent("com.uptoser.springboot.learning"); //父包名
        ...
        strategy.setTablePrefix(PREFIX); // 去掉表前缀
